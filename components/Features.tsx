          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group h-full flex flex-col rounded-2xl border border-slate-200 bg-white/70 px-6 py-6 shadow-sm backdrop-blur-xl transition hover:-translate-y-2 hover:shadow-xl"
              >
                {/* ICON */}
